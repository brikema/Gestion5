            ...
            <div class="page-java _row">
                ...
                <form action="course" class="page-java_content  _row">
                    <div class="_col _col-12">
                        <input type="text" class="form-java_text-searchbar form-java_text _col _col-12 fAwesome" id="studentSearchBar" onkeyup="searchStudent()" placeholder="Chercher un cours...">
                        <div class="list-click--borderless">
                            <% for(CourseDTO e : (List<CourseDTO>) request.getAttribute("list")){ %>
                                    <a href="course" class="list-click_item">
                                        <button class="button-toReset" value="<%= e.getId() %>" name="getCourse" id="getCourse">
                                            <span class="list-click_item_text"><%= e.getCourseSubject() %></span>
                                        </button>
                                    </a>
                            <% } %>
                        </div>
